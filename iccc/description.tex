...
panels in the manner of \citeA{saraceni2016relatedness}. In our second
...
let valid_transitions categories =
  ...
  | _ -> [End] (* error! *)
\end{Verbatim}
\note{RCR}{What do you think about putting this in a pseudocode environment, or in a BNF-type format?}
