...
transitions that connect them. The generation algorithm is:
...
\begin{figure}
\centering
\includegraphics[width=0.8\columnwidth]{comicgen-unconstrained-ok.png}
...
Cohn and his colleagues~\cite{cohn2016visual} investigate the {\em linguistic structure} of
...
selector from before. Examples of the constrained generator's output can 
be found in Figures~\ref{fig:outgood} and~\ref{fig:redgreen}.
